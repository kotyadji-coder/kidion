...
(function() {
  ...
  function showEmptyState() {
    ...
    chatMessages.innerHTML =
      ...
      '<div class="chat-empty__avatar"><img src="/static/kid/img/spark.png" alt="Киди"></div>' +
      '<div class="chat-empty__title">Привет! Я Киди!</div>' +
  ...
  function renderMessage(msg) {
    ...
    const avatar = isUser
      ...
      : '<div class="chat-msg__avatar"><img src="/static/kid/img/spark.png" alt="Киди"></div>';
  ...
  function showTyping() {
    ...
    el.innerHTML = '<div class="chat-msg__avatar"><img src="/static/kid/img/spark.png" alt="Киди"></div>' +
